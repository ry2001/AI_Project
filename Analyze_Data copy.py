...
df = pd.read_csv("C:/Users/RY/Downloads/Telegram Desktop/Mood_lamp_all_comments.csv")
df = list(df['0'])
# print(list(df['0']))
...
plt.bar('None', words, color='r')
plt.title('Words analysed')
plt.ylabel('Number of words')
plt.xlabel('Index')
plt.xticks(rotation=70, fontsize=8)
plt.savefig(f"img/data_words.png")
plt.show()
...
pickle.dump(top_words, open("top_words.pkl", "wb"))
pickle.dump(cleaned_data, open("clean_text.pkl", "wb"))